      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight text-white">Erbil<span className="text-brand-blue">Tech</span></span>
          </div>

          <div className="text-brand-muted text-sm text-center md:text-left">
            &copy; {new Date().getFullYear()} ErbilTech Corp. Tüm hakları saklıdır.
          </div>
